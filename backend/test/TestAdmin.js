...
contract("Admin", function (accounts) {
    ...
    it("should create ranks", async function () {
        const name = "My Ranks";
        ...
        await admin.createRanks(name, numberOfRanks, ranksNames, ranksSymbols, ranksPrices, { from: admin_user });
        ...
        expect(ranksAddress).to.not.equal("0x0000000000000000000000000000000000000000");
    });

    it("should create ticket contract", async function () {
        ...
        const ranks = await Ranks.new(numberOfRanks, ranksNames, ranksSymbols, ranksPrices, { from: admin_user });
        ...
        expect(ticketAddress).to.not.equal("0x0000000000000000000000000000000000000000");
    });
});
